    ...
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if(zadanie == 3)
            {
                ...
                label5.Text = "Zadanie czwarte polega na wcisnięciu dowolnego \n klawisza z klawiatury w momencie usłyszenia \n" +
                    "dzwieku systemowego. Pierwsze trzy próby są instruktażowe \n i nie liczą się do wyniku końcowego ";
            }
            else if(zadanie == 4)
            {
